    ...
    return (
        <section className="design-process">
            ...
            <div className="themes">
                <img src="" alt="Images of Insperation (Imperator Augustus as 'Pontifix Maximus' and Henry Duke of Lancaster with the Order of the Garter)"/>
