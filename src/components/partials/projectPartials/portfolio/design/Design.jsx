        ...
        <section className="design-process">
            ...
            <div className="steps">
                ...
                <div className="grid-wrapper">
                    ...
                    <img className="content-img" id="des-img" src={ ContentPlan } alt="Content Map Image"/>
                    ...
                    <img className="info-img" id="des-img" src={ InfoArchitecure } alt="Information Architecture Image"/>
                    ...
                    <img className="wireframe-img" id="des-img" src={ Wireframe } alt="Wireframe / Mockup"/>
                </div>
            </div>
        </section>
    );
