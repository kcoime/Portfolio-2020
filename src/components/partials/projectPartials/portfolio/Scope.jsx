        ...
        <sections>
            <div className="content">
                <div className="objectives">
                    ...
                    <p>The objective of the site was to challange myself and my understanding of the React Framework by creating a site using it's base features. As mentioned before this is NOT at all the correct way this framework is to be used, infact React may be "overkill" if one where to use it this way.</p>
                </div>
                <div className="team">
                    <h3>Team Members:</h3>
                    <ul>
